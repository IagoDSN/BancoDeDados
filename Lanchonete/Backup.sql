...
INSERT INTO `cargo` (`codCargo`, `nomeCargo`, `salarioInicial`, `funcoes`) VALUES
	...
	(2, 'Balconista', 1804, 'Realizar o processo da venda'),
...
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  `dataHora` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `formaPagamento` enum('PIX','Dinheiro','Cartão de Crédito','Cartão de Débito','Ticket Akimentação','Convênio','Cheque') NOT NULL,
